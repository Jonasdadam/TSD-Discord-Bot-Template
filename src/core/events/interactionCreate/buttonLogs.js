...
module.exports = async (client, interaction) => {
	...
	try {
		const buttonEmbed = new EmbedBuilder()
			...
			.addFields({ name: "Server", value: interaction.guild.name, inline: false }, { name: "Button ID", value: interaction.customId, inline: false }, { name: "User", value: `${interaction.user.tag} (${interaction.user.id})`, inline: false })
			.setTimestamp()
