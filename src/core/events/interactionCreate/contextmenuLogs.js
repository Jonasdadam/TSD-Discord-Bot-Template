...
module.exports = async (client, interaction) => {
	...
	try {
		const contextEmbed = new EmbedBuilder()
			...
			.addFields({ name: "Server", value: interaction.guild.name, inline: false }, { name: "Contextmenu", value: interaction.commandName, inline: false }, { name: "User", value: `${interaction.user.tag} (${interaction.user.id})`, inline: false })
			.setTimestamp()
